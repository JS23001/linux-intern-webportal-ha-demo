...
| T11 | Kør planlagt engangstest af lederstyret pgBackRest-backup. | På det aftalte tidspunkt udfører kun den aktuelle Patroni-leder én inkrementel backup; den passive node udfører ingen backup. | Planlagt 2026-08-26 kl. 10:30 dansk tid: transient systemd-timer `pgbackrest-oneoff-20260826-0830` er aktiv på db01 og db02 og kører `pgbackrest-leader-backup incr` kl. 08:30 UTC. |
