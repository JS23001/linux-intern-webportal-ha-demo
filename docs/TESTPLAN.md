...
| T08 | Gendan backup fra PBS01. | Gendannet portal/data kan verificeres. | Delvist bestået 2026-08-25: CT101 blev gendannet midlertidigt som CT201 fra PBS og derefter fjernet. PostgreSQL-restore til særskilt testmappe blev påbegyndt, men pgBackRest SFTP-læsning fejlede med libssh2-fejl 4; direkte SFTP-læsning af samme fil lykkedes. Fejlretning og ny test mangler. |
