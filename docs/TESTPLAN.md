...
| T10 | Kontrollér første automatiske natlige backupkørsel. | PBS-job og lederstyret pgBackRest-job er fuldført uden fejl før opdateringsvedligeholdelse. | Delvist bestået 2026-08-26: PBS-jobbet tog snapshots af CT101–106 kl. 01:30 lokal tid, alle med PBS-verifikation `ok`. pgBackRest-jobbet kørte ikke, fordi cronfilen manglede afsluttende linjeskift. Filen er rettet; leder-scriptet gennemførte en inkrementel backup kl. 07:28 UTC med `status: ok`, og en isoleret cron-parser-test bestod. Næste ordinære natlige pgBackRest-kørsel verificeres før opdateringer. |
