...
| T10 | Kontrollér første automatiske natlige backupkørsel. | PBS-job og lederstyret pgBackRest-job er fuldført uden fejl før opdateringsvedligeholdelse. | Delvist bestået: PBS tog igen snapshots af CT101–106 natten til 2026-08-27, alle med verifikation `ok`. pgBackRest-cron startede kl. 00:15 UTC, men fejlede, fordi `runuser` ikke fandtes i crons `PATH`. Scriptet bruger nu den absolutte sti `/usr/sbin/runuser` på begge noder. En test med samme minimale miljø oprettede backup `20260825-105455F_20260827-070850I` med `status: ok`; næste ordinære kørsel verificeres før opdateringer. |
